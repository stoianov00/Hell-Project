...
public class HeroInventory : IInventory
{
    ...
    {
        get => this.commonItems.Values.Sum(i => (long)i.StrengthBonus);
    }

    public long TotalAgilityBonus
    {
        get => this.commonItems.Values.Sum(i => (long)i.AgilityBonus);
    }

    public long TotalIntelligenceBonus
    {
        get => this.commonItems.Values.Sum(i => (long)i.IntelligenceBonus);
    }

    public long TotalHitPointsBonus
    {
        get => this.commonItems.Values.Sum(i => (long)i.HitPointsBonus);
    }

    public long TotalDamageBonus
    {
        get => this.commonItems.Values.Sum(i => (long)i.DamageBonus);
    }
